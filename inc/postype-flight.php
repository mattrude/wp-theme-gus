...
function post_type_flight() {
    $labels = array(
        ...
        'all_items'           => __( 'All Flights', 'gus' ),
        'view_item'           => __( 'View Flight', 'gus' ),
        'add_new_item'        => __( 'Add New Flight', 'gus' ),
        'add_new'             => __( 'New Flight', 'gus' ),
        'edit_item'           => __( 'Edit Flight', 'gus' ),
        'update_item'         => __( 'Update Flight', 'gus' ),
